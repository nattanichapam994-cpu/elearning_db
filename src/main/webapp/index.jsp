...
<head>
<meta charset="UTF-8">
<title>คลังความรู้ - E-Learning</title>
...
<div class="user-welcome">สวัสดีคุณ <strong><%= fullName %></strong> | ยินดีต้อนรับสู่แหล่งเรียนรู้ออนไลน์</div>
...
<span>🚀</span> เลือกหัวข้อที่ต้องการศึกษา
</h2>
...
<%
                ...
                try {
                    ...
                    // ดึงรายชื่อวิชาทั้งหมดจากฐานข้อมูล
                    ...
                    while (rs.next()) {
                        ...
                        // กำหนด Emoji ตามชื่อวิชาเบื้องต้น

                        String icon = "📚";

                        if(cName.contains("C")) icon = "💻";

                        if(cName.contains("เว็บ")) icon = "🌐";

                        if(cName.contains("ฐานข้อมูล")) icon = "🗄️";

            %>
<div class="course-card">
<div>
<div class="course-icon"><%= icon %></div>
<div style="color: #1877f2; font-size: 0.85rem; font-weight: bold;">หมวดหมู่รหัส #<%= cId %></div>
<h3 class="course-title"><%= cName %></h3>
<p class="course-desc">คลิกเพื่อเข้าชมเนื้อหาการสอน วิดีโอ และเอกสารประกอบการเรียนวิชา <%= cName %></p>
</div>
...
<%
                    ...
                    out.println("<div style='color:red; padding: 20px; background: white; border-radius: 10px;'>เกิดข้อผิดพลาดในการเชื่อมต่อ: " + e.getMessage() + "</div>");
